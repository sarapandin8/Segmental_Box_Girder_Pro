...
def test_m3d_schema_version_is_updated():
    ...
    assert 'PROJECT_SCHEMA_VERSION = "0.4.93-commercial-psloss26a-effective-prestress-loss-audit"' in validation_src
...
def test_psloss26a_effective_prestress_loss_audit_and_formula_polish():
    ...
    assert 'PROJECT_SCHEMA_VERSION = "0.4.93-commercial-psloss26a-effective-prestress-loss-audit"' in validation_src
    assert "4.6 Effective Prestress Source Map and Loss Audit" in src
