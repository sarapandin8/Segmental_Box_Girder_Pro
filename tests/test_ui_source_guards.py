...
def test_m3d_schema_version_is_updated():
    ...
    assert 'PROJECT_SCHEMA_VERSION = "0.4.81-commercial-psloss21-relaxation-source-preview"' in validation_src
...
def test_psloss14_header_and_next_step_consistency_cleanup():
    ...
    assert "segmental_box_girder_psloss21_summary.md" in src
