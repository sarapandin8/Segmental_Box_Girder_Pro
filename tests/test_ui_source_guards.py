...
def test_m3d_schema_version_is_updated():
    ...
    assert 'PROJECT_SCHEMA_VERSION = "0.4.83-commercial-psloss23-td-handoff-relax-wording"' in validation_src
...
def test_psloss14_header_and_next_step_consistency_cleanup():
    ...
    assert "segmental_box_girder_psloss23_summary.md" in src
