...
Commercial M2 uses a report-driven data model while preserving the stable
calculation-engine inputs from M1. Internal UI units are kN, m, MPa, and mm.
"""

BG40_DEFAULT = {
    "meta": {
        "schema_version": "0.3.0-commercial-m2",
    ...
    "load_components": {
        "sdl_components": [
            {"Component": "Rails w/Fastener", "Single Track (kN/m)": 1.46, "Double Track (kN/m)": 2.93},
            {"Component": "Track Supporting Structure (Plinth)", "Single Track (kN/m)": 20.00, "Double Track (kN/m)": 40.00},
            {"Component": "Signaling Equipment", "Single Track (kN/m)": 0.51, "Double Track (kN/m)": 0.51},
            {"Component": "Power Supply", "Single Track (kN/m)": 2.00, "Double Track (kN/m)": 2.00},
            {"Component": "Telecommunication", "Single Track (kN/m)": 0.20, "Double Track (kN/m)": 0.20},
            {"Component": "Parapet / Noise Barrier", "Single Track (kN/m)": 29.40, "Double Track (kN/m)": 29.40},
            {"Component": "Concrete Cable Box", "Single Track (kN/m)": 8.00, "Double Track (kN/m)": 8.00},
            {"Component": "Cables", "Single Track (kN/m)": 0.07, "Double Track (kN/m)": 0.15},
            {"Component": "Drainage", "Single Track (kN/m)": 0.50, "Double Track (kN/m)": 1.00},
            {"Component": "Ballast (Ballastless - none)", "Single Track (kN/m)": 0.00, "Double Track (kN/m)": 0.00},
        ],
